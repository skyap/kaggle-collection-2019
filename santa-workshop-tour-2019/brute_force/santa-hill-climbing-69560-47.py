...
#     np.random.seed(7)
    ...
    f_days, c_days, n_days = load("../input/santa-output/submission69560.47.csv")
    hill_climbing(f_days, c_days, n_days, lahc_size=100, stuck_time=8*3600, limit_time=8*3600)
    from os import path
    if path.exists("best.csv"):
