...
function param(){
    ...
    // lsObjectiveThreshold = {64000,6030};
    // 62868.000000 6020.043432
    lsObjectiveThreshold = {63500,7000};
...
function model(){
    ...
    constraint accounting_penalty<7000;
    constraint accounting_penalty>5000;
    // minimize prefer_costs+accounting_penalty;
    // minimize prefer_costs+accounting_penalty+occupancy_costs;
    // constraint accounting_penalty==6020.043432;
    minimize prefer_costs;
    minimize accounting_penalty;
    // minimize prefer_costs;
